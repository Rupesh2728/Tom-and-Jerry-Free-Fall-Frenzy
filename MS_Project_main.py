...
def draw_clouds(cloud_coordinates_list, images):
    ...
    for j in range(len(cloud_coordinates_list)):
        ...
        platform = pygame.rect.Rect((cloud_coordinates_list[j][0] + 5, cloud_coordinates_list[j][1] + 30), (120, 10))
...
def update_objects(cloud_list, play_y, enemies_list):
    lowest_cloud = 0
    update_speed = 10
    ...
    return play_y, cloud_list, enemies_list  # Returning the clouds coordinates and updated play_y value
...
while run:  # Game page loop
    ...
    player_y, clouds, enemies = update_objects(clouds_coordinates, player_y, enemies_coordinates)
